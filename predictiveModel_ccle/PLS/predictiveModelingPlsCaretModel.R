...
for(kk in 1:ncol(dataSets_ccle$responseData)){  
  ...
  resultsScale<-crossValidatePredictiveModel1(filteredFeatureDataScaled, filteredResponseDataScaled, model = CaretModel$new(modelType = "pls"), tuneGrid=tuneGrid, trControl = myTrControl)
  filename <- paste("cvDrug_",kk,"_PLS_scale.Rdata",sep ="")  
