...
for(kk in 2:ncol(dataSets_ccle$responseData)){  
  ...
  #resultsUnscale<-crossValidatePredictiveModel(filteredFeatureData, filteredResponseData, model = CaretModel$new(modelType = "svmLinear"), trControl = myTrControl)
  
  filename <- paste("cvDrug_",kk,"_SVM.Rdata",sep ="")  
