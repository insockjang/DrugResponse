...
for(kk in 1:ncol(dataSet1$responseData)){  
  ...
  resultsCGC<-crossValidatePredictiveModel1(Data1$featureData, Data1$responseData, model = CaretModel$new(modelType = "pcr"), trControl = myTrControl,tuneGrid = tuneGrid)
  resultsTF<-crossValidatePredictiveModel1(Data2$featureData, Data2$responseData, model = CaretModel$new(modelType = "pcr"), trControl = myTrControl,tuneGrid = tuneGrid)
  resultsM<-crossValidatePredictiveModel1(Data3$featureData, Data3$responseData, model = CaretModel$new(modelType = "pcr"), trControl = myTrControl,tuneGrid = tuneGrid)
  resultsR<-crossValidatePredictiveModel1(Data4$featureData, Data4$responseData, model = CaretModel$new(modelType = "pcr"), trControl = myTrControl,tuneGrid = tuneGrid)
