...
###################################################
modelClassFile = ("~/COMPBIO/trunk/users/jang/R5/myCoxModel")
source(modelClassFile)

modelClassFile1 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_PLD/MC_unpenalty/metabricENetCoxModelCancerCensusMC_unpenalty.R")
modelClassFile2 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_PLD/MC_unpenalty/metabricENetCoxModelMeanMarginalAssociationMC_unpenalty.R")
modelClassFile3 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_PLD/MC_unpenalty/metabricENetCoxModelMeanMetabricClusteringMC_unpenalty.R")
modelClassFile4 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_PLD/MC_unpenalty/metabricENetCoxModelMeanTopvaringHigginsMC_unpenalty.R")
modelClassFile5 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_PLD/MC_unpenalty/metabricENetCoxModelMeanTopvaringMC_unpenalty.R")
...
### step 6: submitModel
###################################################
myModelName1 = "InSock Lasso PLD MC_unpenalty CancerCensus" 
myModelName2 = "InSock Lasso PLD MC_unpenalty MarginalAssociation" 
myModelName3 = "InSock Lasso PLD MC_unpenalty MetabricClustering" 
myModelName4 = "InSock Lasso PLD MC_unpenalty TopVaringHiggins" 
myModelName5 = "InSock Lasso PLD MC_unpenalty TopVaring" 

submitCompetitionModel(modelName = myModelName1, trainedModel=CancerCensusMC_unpenalty,rFiles=list(modelClassFile1,modelClassFile), parentDatasetId = "syn308537")
submitCompetitionModel(modelName = myModelName2, trainedModel=MarginalAssociationMC_unpenalty,rFiles=list(modelClassFile2,modelClassFile), parentDatasetId = "syn308537")
submitCompetitionModel(modelName = myModelName3, trainedModel=MetabricClusteringMC_unpenalty,rFiles=list(modelClassFile3,modelClassFile), parentDatasetId = "syn308537")
submitCompetitionModel(modelName = myModelName4, trainedModel=TopvaringHigginsMC_unpenalty,rFiles=list(modelClassFile4,modelClassFile), parentDatasetId = "syn308537")
submitCompetitionModel(modelName = myModelName5, trainedModel=TopvaringMC_unpenalty,rFiles=list(modelClassFile5,modelClassFile), parentDatasetId = "syn308537")
