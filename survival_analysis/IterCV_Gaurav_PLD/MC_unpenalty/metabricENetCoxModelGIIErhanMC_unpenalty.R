metabricENetCoxModelGIIErhanMC_unpenalty <- setRefClass(Class = "metabricENetCoxModelGIIErhanMC_unpenalty",                              
                                                        ...
                                                        methods = list(
                                                          ...
                                                          customTrain = function(exprData,copyData,clinicalFeaturesData,clinicalSurvData, GII = 1,...){
                                                            ...
                                                            featureData<-featureData[union(erhanFeature,GII_name),]
                                                            ...
                                                            .self$model <- .self$childclass$customTrain(FEA,
                                                                                                        clinicalSurvData,
                                                                                                        penalty.factor = c(rep(1,nrow(featureData)),rep(0,ncol(RES))),...)
