require(glmnet)
rankRidgeModelExpCnv <- setRefClass(Class = "rankRidgeModelExpCnv",
                                    ...
                                    methods = list(
                                      ...
                                      customTrain = function(exprData, copyData, clinicalFeaturesData,clinicalSurvData,...){
                                        ...
                                        featureData <-createAggregateFeatureDataSet(list(expr = exprData[exprTFM$M,],copy = copyData[copyTFM$M,]))
                                        ...
                                        .self$model<-cv.glmnet(as.matrix(FEA1[,(allFeature[-1]-1)]),clinicalSurvData,family = "cox",nfolds =10,alpha = 0.00001)
                                      },
