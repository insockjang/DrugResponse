...
### step 6: submitModel
###################################################
myModelName1 = "InSock ENet max MC_penalty CancerCensus" 
myModelName2 = "InSock ENet max MC_penalty MarginalAssociation" 
myModelName3 = "InSock ENet max MC_penalty MetabricClustering" 
myModelName4 = "InSock ENet max MC_penalty TopVaringHiggins" 
myModelName5 = "InSock ENet max MC_penalty TopVaring" 
