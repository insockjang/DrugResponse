...
### step 6: submitModel
###################################################
myModelName1 = "InSock ENet max MC_unpenalty CancerCensus" 
myModelName2 = "InSock ENet max MC_unpenalty MarginalAssociation" 
myModelName3 = "InSock ENet max MC_unpenalty MetabricClustering" 
myModelName4 = "InSock ENet max MC_unpenalty TopVaringHiggins" 
myModelName5 = "InSock ENet max MC_unpenalty TopVaring" 
