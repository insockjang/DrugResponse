...
modelClassFile1 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_max/MC_unpenalty/metabricENetCoxModelCancerCensusMC_unpenalty.R")
modelClassFile2 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_max/MC_unpenalty/metabricENetCoxModelMeanMarginalAssociationMC_unpenalty.R")
modelClassFile3 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_max/MC_unpenalty/metabricENetCoxModelMeanMetabricClusteringMC_unpenalty.R")
modelClassFile4 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_max/MC_unpenalty/metabricENetCoxModelMeanTopvaringHigginsMC_unpenalty.R")
modelClassFile5 = ("~/COMPBIO/trunk/users/jang/survival_analysis/IterCV_Gaurav_max/MC_unpenalty/metabricENetCoxModelMeanTopvaringMC_unpenalty.R")
...
### step 6: submitModel
###################################################
myModelName1 = "InSock Lasso max MC_unpenalty CancerCensus" 
myModelName2 = "InSock Lasso max MC_unpenalty MarginalAssociation" 
myModelName3 = "InSock Lasso max MC_unpenalty MetabricClustering" 
myModelName4 = "InSock Lasso max MC_unpenalty TopVaringHiggins" 
myModelName5 = "InSock Lasso max MC_unpenalty TopVaring" 
