...
### step 6: submitModel
###################################################
myModelName1 = "InSock ENet max M CancerCensus" 
myModelName2 = "InSock ENet max M MarginalAssociation" 
myModelName3 = "InSock ENet max M MetabricClustering" 
myModelName4 = "InSock ENet max M TopVaringHiggins" 
myModelName5 = "InSock ENet max M TopVaring" 
