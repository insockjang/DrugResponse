bsCoefMCunpenalty <- setRefClass(Class = "bsCoefMCunpenalty",                              
                       ...
                       methods = list(
                         ...
                         customCoef = function(exprData,copyData,clinicalFeaturesData,clinicalSurvData, priorName, ...){
                           ...
                           .self$model$customTrain(FEA,clinicalSurvData,penalty.factor = c(rep(1,nrow(featureData)),rep(0,ncol(RES))),...)
