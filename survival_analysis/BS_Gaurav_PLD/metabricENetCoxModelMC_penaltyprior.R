...
metabricENetCoxModelMC_penaltyprior <- setRefClass(Class = "metabricENetCoxModelMC_penaltyprior",                              
                                                          ...
                                                          methods = list(
                                                            ...
                                                            customTrain = function(exprData,copyData,clinicalFeaturesData,clinicalSurvData, priorName, beta,...){
                                                              ...
                                                              .self$model<-coxph(clinicalSurvData ~.,data = as.data.frame(FEA[,beta]),control = coxph.control(iter.max = 1000))
