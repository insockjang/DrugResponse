...
modelClassFile1 = ("~/COMPBIO/trunk/users/jang/survival_analysis/Gaurav/ML/metabricENetCoxModelCancerCensusM.R")
modelClassFile2 = ("~/COMPBIO/trunk/users/jang/survival_analysis/Gaurav/ML/metabricENetCoxModelMeanMarginalAssociationM.R")
modelClassFile3 = ("~/COMPBIO/trunk/users/jang/survival_analysis/Gaurav/ML/metabricENetCoxModelMeanMetabricClusteringM.R")
modelClassFile4 = ("~/COMPBIO/trunk/users/jang/survival_analysis/Gaurav/ML/metabricENetCoxModelMeanTopvaringHigginsM.R")
modelClassFile5 = ("~/COMPBIO/trunk/users/jang/survival_analysis/Gaurav/ML/metabricENetCoxModelMeanTopvaringM.R")
...
### step 6: submitModel
###################################################
myModelName1 = "InSock Lasso M CancerCensus" 
myModelName2 = "InSock Lasso M MarginalAssociation" 
myModelName3 = "InSock Lasso M MetabricClustering" 
myModelName4 = "InSock Lasso M TopVaringHiggins" 
myModelName5 = "InSock Lasso M TopVaring" 

submitCompetitionModel(modelName = myModelName1, trainedModel=CancerCensusM,rFiles=list(modelClassFile1), isPracticeModel=TRUE)
submitCompetitionModel(modelName = myModelName2, trainedModel=MarginalAssociationM,rFiles=list(modelClassFile2), isPracticeModel=TRUE)
submitCompetitionModel(modelName = myModelName3, trainedModel=MetabricClusteringM,rFiles=list(modelClassFile3), isPracticeModel=TRUE)
submitCompetitionModel(modelName = myModelName4, trainedModel=TopvaringHigginsM,rFiles=list(modelClassFile4), isPracticeModel=TRUE)
submitCompetitionModel(modelName = myModelName5, trainedModel=TopvaringM,rFiles=list(modelClassFile5), isPracticeModel=TRUE)
