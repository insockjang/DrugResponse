...
resultsRandomForest_100<-crossValidatePredictiveModel1(filteredFeatureData, factor(filteredResponseData), model = myRandomForestModel$new(), numFolds = 5,ntree = 100)
...
filename = paste("~/COMPBIO/trunk/users/jang/Lara_BSEP/ROCR_continuous_cv5_96.Rdata",sep = "")
