...
for(kk in 1:ncol(pData(adf_drug))){
  ...
  filename = paste("~/COMPBIO/trunk/users/jang/drugResponse_woExp/CCLE/catLasso2/ROCR_mean_sd_",kk,".Rdata",sep = "")
  ...
  filename = paste("~/COMPBIO/trunk/users/jang/drugResponse_woExp/CCLE/catLasso2/ROCR_mean_",kk,".Rdata",sep = "")
  save(resultsCat,file = filename)
  ...
  filename = paste("~/COMPBIO/trunk/users/jang/drugResponse_woExp/CCLE/catLasso2/ROCR_median_mad_",kk,".Rdata",sep = "")
  save(resultsCat,file = filename)
  ...
  filename = paste("~/COMPBIO/trunk/users/jang/drugResponse_woExp/CCLE/catLasso2/ROCR_median_",kk,".Rdata",sep = "")
  save(resultsCat,file = filename)
  print(kk)  
}
