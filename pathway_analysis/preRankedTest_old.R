preRankedTest_old <- function(reference,geneset,np=100,w=1){
  # This must be wrong because it does not replicate the exact same result with GSEA java code provided by Broad Institute
