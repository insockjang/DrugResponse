...
data_drug <- as.numeric(as.matrix(header2$APOE))
...
save(resultsLasso,resultsENet,file = "~/Results/AD/APOE/AD/bs100Results_exprProtein2.Rdata")
...
save(resultsLasso,resultsENet,file = "~/Results/AD/APOE/AD/bs100Results_exprProtein1.Rdata")
