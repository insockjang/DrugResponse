...
save(resultsLasso,resultsENet,file = "~/Results/AD/BRAAK/Control/bs100Results_exprProtein2.Rdata")
...
save(resultsLasso,resultsENet,file = "~/Results/AD/BRAAK/Control/bs100Results_exprProtein1.Rdata")
