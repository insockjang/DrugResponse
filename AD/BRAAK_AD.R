...
save(resultsLasso,resultsENet,file = "~/Results/AD/BRAAK/AD/bs100Results_exprProtein2.Rdata")
...
save(resultsLasso,resultsENet,file = "~/Results/AD/BRAAK/AD/bs100Results_exprProtein1.Rdata")
