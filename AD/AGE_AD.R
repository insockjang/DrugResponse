...
data_drug <- as.numeric(as.matrix(header2$AGE))
...
save(resultsLasso,resultsENet,file = "~/Results/AD/AGE/AD/bs100Results_exprProtein2.Rdata")
...
save(resultsLasso,resultsENet,file = "~/Results/AD/AGE/AD/bs100Results_exprProtein1.Rdata")
