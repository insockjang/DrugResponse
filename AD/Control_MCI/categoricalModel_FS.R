...
save(resultsLasso,file = "~/COMPBIO/trunk/users/jang/AD/Control_MCI/bs100Lasso.Rdata")
save(resultsENet,file = "~/COMPBIO/trunk/users/jang/AD/Control_MCI/bs100ENet.Rdata")
