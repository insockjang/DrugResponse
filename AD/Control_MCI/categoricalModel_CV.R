...
save(resultsLasso,file = "~/COMPBIO/trunk/users/jang/AD/Control_MCI/cv5Lasso.Rdata")
save(resultsENet,file = "~/COMPBIO/trunk/users/jang/AD/Control_MCI/cv5ENet.Rdata")
