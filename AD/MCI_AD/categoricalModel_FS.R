...
save(resultsLasso,file = "~/COMPBIO/trunk/users/jang/AD/MCI_AD/bs100Lasso.Rdata")
save(resultsENet,file = "~/COMPBIO/trunk/users/jang/AD/MCI_AD/bs100ENet.Rdata")
