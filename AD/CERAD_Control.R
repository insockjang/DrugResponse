...
data_drug <- as.numeric(as.matrix(header2$CERAD))
...
save(resultsLasso,resultsENet,file = "~/Results/AD/CERAD/Control/bs100Results_exprProtein2.Rdata")
...
save(resultsLasso,resultsENet,file = "~/Results/AD/CERAD/Control/bs100Results_exprProtein1.Rdata")
